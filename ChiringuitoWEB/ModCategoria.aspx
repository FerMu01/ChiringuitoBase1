<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModCategoria.aspx.cs" Inherits="ChiringuitoWEB.ModCategoria" %>
...
<head runat="server">
    ...
    <style>
        body {
            background-image: url('imagenes/top-view-fish-chips-plate-with-copy-space.jpg');
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            var textDescripcion = document.getElementById('<%= textDescripcion.ClientID %>').value.trim();
            var textDescuento = document.getElementById('<%= textDescuento.ClientID %>').value.trim();

            if (textName === "" || textDescripcion === "" || textDescuento === "") {
                alert("Todos los campos son obligatorios.");
                return false;
            }

            if (textName.startsWith(" ") || textDescripcion.startsWith(" ") || textDescuento.startsWith(" ")) {
                alert("El primer caracter no puede ser un espacio.");
                return false;
            }
    ...
    <form id="form1" runat="server">
        <div class="card">
            <div class="form-section">
                ...
                <label for="cinit">Nombre Categoria</label>
                <asp:TextBox ID="textName" runat="server" placeholder="Nombre Categoria" onkeypress="preventLeadingSpace(event)"></asp:TextBox>

                <label for="nombre-proveedor">Descripcion</label>
                <asp:TextBox ID="textDescripcion" runat="server" placeholder="Descripcion" onkeypress="preventLeadingSpace(event)"></asp:TextBox>

                <label for="numero-telefono">Descuento</label>
                <asp:TextBox ID="textDescuento" runat="server" placeholder="Descuento" onkeypress="preventLeadingSpace(event)"></asp:TextBox>

                <asp:Button ID="btnModificar" runat="server" CssClass="volver" Text="Modificar" OnClick="btnModificar_Click" />
                <asp:Button ID="btnGuardar" runat="server" CssClass="volver" Text="Guardar" OnClick="btnGuardar_Click" OnClientClick="return validateForm();" />
            ...
            <div>
                <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="striped-table">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Nombre Categoria" HeaderText="Nombre Categoria" ItemStyle-width="150" />
